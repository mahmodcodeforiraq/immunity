...
class ShowMostafidStoriesDepartment extends StatefulWidget {

  NormalUser _normalUser;



  ShowMostafidStoriesDepartment(this._normalUser);

  @override
  _ShowMostafidStoriesDepartmentState createState() =>
      _ShowMostafidStoriesDepartmentState();
}

DatabaseReference MostafidRefrance;

bool showAddPost=false;

class _ShowMostafidStoriesDepartmentState extends State<ShowMostafidStoriesDepartment> {
  ...
  void initState(){
    ...
    MostafidRefrance =  FirebaseDatabase.instance.reference().child('Users').child('PostsMostafad');

    _onPostAddedStreamSub =
        MostafidRefrance.onChildAdded.listen(_onPostAdded);
    _onPostUpdatedStreamSub =
        MostafidRefrance.onChildChanged.listen(_onPostUpdated);
    ...
    return new Container(
      child: Scaffold(
        ...
        body: Column(
          ...
          children: <Widget>[
            Center(
              child: contaierSuccessStories2(context),
            ),
            SizedBox(height: 15,),
                                ...
                                title:new Column(
                                  children: <Widget>[
                                    ...
                                    new Column(
                                      textDirection:  TextDirection.rtl,
                                      children: <Widget>[
                                        new Text('${items[position].nameUser}',textAlign: TextAlign.center,),
                                        new Divider(
                                          height: 3,
                                          color: Colors.black,
                                        ),
  ...
  Widget contaierSuccessStories2(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(top: 10),
        ...
        child: Column(
          children: <Widget>[
            containerImage(context, 'images/Group308.png'),

            centerAddress('المستفيدين مو كورونا'),
